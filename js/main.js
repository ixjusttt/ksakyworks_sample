...
$('.JS_Click_Trigger').on('click', function(){
	...
	const titleArray = $(this).data('index');
		$('.youtube').html(infos[titleArray].preview);
		$('.movtext .date').text(infos[titleArray].date);
		$('.movtext .eventname').text(infos[titleArray].eventname);
		$('.movtext .circle').text(infos[titleArray].circle);
		$('.movtext .subtitle').text(infos[titleArray].subtitle);
		$('.movtext .title').text(infos[titleArray].title);
		$('.movtext .artist').text(infos[titleArray].artist);
		$('.movtext .item01').text(infos[titleArray].item01);
		$('.movtext .item01_1').text(infos[titleArray].item01_1);
		$('.movtext .item02').text(infos[titleArray].item02);
		$('.movtext .item02_1').text(infos[titleArray].item02_1);
		$('.movtext .item03').text(infos[titleArray].item03);
		$('.movtext .item03_1').text(infos[titleArray].item03_1);
		$('.movtext .item04').text(infos[titleArray].item04);
		$('.movtext .item04_1').text(infos[titleArray].item04_1);
		$('.mov .small').text(infos[titleArray].small);
		$('.movtext .button').attr("href",infos[titleArray].url);
